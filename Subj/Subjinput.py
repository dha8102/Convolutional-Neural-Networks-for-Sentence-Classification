...
def inputdata():
    data_file = ["./Subj/plot.tok.gt9.5000", "./Subj/quote.tok.gt9.5000"]
    voca = {}
    x = []
    y = []
    vocacnt = 0
    ...
    with open("./Subj/plot.tok.gt9.5000", encoding="latin-1") as f:
        while True:
            line = f.readline()
            if not line:
                break
    ...
    with open("./Subj/quote.tok.gt9.5000", encoding="latin-1") as f:
        while True:
            line = f.readline()
            if not line:
                break
...
if __name__ == "__main__":
    ...
    f = open("./Subj_original_data.bin", "wb+")
    pickle.dump(total_data, f)
    f.close()
    print("Subj_original_data produced.")
